...
import { Search, ChevronDown, Music, Users, Settings, LogOut, BookOpen, MessageSquare, FileText } from 'lucide-react';
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="relative">
            ...
            >
              ...
              <span className="hidden sm:block text-sm font-medium text-[#1F2C24]">
                {user.username}
              </span>
